            ...
            <div class="row">    
                <div class="col-md-5 col-md-offset-3 col-sm-12 text-right">
                    <div class="call_us_text">
                        <a href="#"><i class="fa fa-clock-o"></i> Order Coffee </a>
                        <a href="#"><i class="fa fa-phone"></i>+55 123 456 78</a>
                    </div>
                </div>
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand our_logo" href="#"><img src="assets/images/logo-for-coffee-shop-vector-20164369.png" alt="" /></a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="#features">New Feature</a></li>
                                ...
                                <?php if (isset($_SESSION['username'])): ?>
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                            Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?> <span class="caret"></span>
                                        </a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="copyright wow zoomIn" data-wow-duration="3s">
                            <p>Made with <i class="fa fa-heart"></i> by <a href="http://bootstrapthemes.com">Bootstrap Themes</a>2016.  Modified by <a href="#">Aysha Akter</a>
